...
def continue_training(checkpoint_path, additional_episodes=2000, render=False):
    ...
    Args:
        checkpoint_path: path to the saved model (e.g., "ddqn_results/final_model.pt")
...
if __name__ == "__main__":
    ...
    # continue_training("ddqn_results/final_model.pt", additional_episodes=3000, render=False)

    # To train with visuals (slow, but you can watch):
    # train(num_episodes=100, render=True)

    # To watch a trained agent play:
    # watch("ddqn_results/final_model.pt")